	...
	if opt2=="1":
		...
		while ammount2<ammount+1:
			try:
				...
				if ammount2==1:
					print(cyan+"\n\t  BD SMS==>   "+green+"[✓] 1st SMS Sent.")
				elif ammount2==2:
					print(cyan+"\n\t  BD SMS==>   "+green+"[✓] 2nd SMS Sent.")
				elif ammount2==3:
					print(cyan+"\n\t  BD SMS==>   "+green+"[✓] 3rd SMS Sent.")
				else:
					print(cyan+"\n\t  BD SMS==>   "+green+"[✓] "+str(ammount2)+"th SMS Sent.")
				time.sleep(1)
				totalsent+=1
				ammount2+=1
			except:
				if ammount2==1:
					print(cyan+"\n\t  BD SMS==>   "+red+"[×] 1st SMS Not Sent.")
				elif ammount2==2:
					print(cyan+"\n\t  BD SMS==>   "+red+"[×] 2nd SMS Not Sent.")
				elif ammount2==3:
					print(cyan+"\n\t  BD SMS==>   "+red+"[×] 3rd SMS Not Sent.")
				else:
					print(cyan+"\n\t  BD SMS==>   "+red+"[×] "+str(ammount2)+"th SMS Not Sent.")
					time.sleep(10)
					ammount2+=1
		...
		lastt=str(input(cyan+"\n\n\t\t  [✓] All Done!\n\t [•] Now Press Enter to start again!!\n"))
		os.system('clear')
		notice=""
		text=green+"\n\n\t\t★★★BD SMS BOMBER★★★   \n" 
		header()
